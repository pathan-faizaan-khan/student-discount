    ...
    return (
      <div className="flex flex-col items-center mt-20 space-y-10">
        <section className="flex flex-col  py-8 px-4 mb-5 rounded-sm shadow-xl ">
          <p className="font-semibold flex justify-between"><h1 className="text-purple-500">Name :</h1> {user?.name || "John Doe"}</p>
          <p className="font-semibold flex justify-between"><h1 className="text-purple-500">College :</h1> {user?.college || "Default College"}</p>
          <p className="font-semibold flex justify-between"><h1 className="text-purple-500">Email :</h1> {user?.email || "example@mail.com"}</p>
          <p className="font-semibold flex justify-between"><h1 className="text-purple-500">Phone No :</h1> {user?.phone || "1234567890"}</p>
        </section>
        <div className="mb-10 ">
